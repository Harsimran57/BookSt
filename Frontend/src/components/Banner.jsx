        ...
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-36">
          <div className="space-y-8">
            <h1 className="text-2xl md:text-4xl font-bold">
              Hello Buddy! Here is your online book store{" "}
              <span className="text-blue-500">let's go!!!</span>
            </h1>
          ...
          <button className="btn mt-6 bg-blue-500 text-white hover:bg-blue-700 border-none">Get Started</button>
        </div>
